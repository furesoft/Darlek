...
#pragma warning restore CA1707 // Идентификаторы не должны содержать символы подчеркивания
        ...
        internal JSObject GetDefaultPrototype()
        {
            ...
            {
                if (_oValue is JSValue oValueAsJsObject)
        ...
        {
            return new BaseLibrary.String(value.ToString());
        }
        ...
        {
            return (BaseLibrary.Boolean)value;
        }
        ...
        {
            return new BaseLibrary.String(value);
        }
        ...
        protected internal virtual IEnumerator<KeyValuePair<string, JSValue>> GetEnumerator(bool hideNonEnumerable, EnumerationMode enumeratorMode)
        {
            ...
            {
                if (_oValue is JSValue innerObject)
        ...
        #endregion Члены IComparable<JSValue>
