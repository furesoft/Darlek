...
namespace BookGenerator.Core.Engine.Expressions
{
    ...
    public class Assignment : Expression
    {
        ...
        public override void Optimize(ref CodeNode _this, FunctionDefinition owner, InternalCompilerMessageCallback message, Options opts, FunctionInfo stats)
        {
            ...
            if (_left is VariableReference vr)
            {
            ...
            if (_left is Variable variable && variable._descriptor.IsDefined && (_codeContext & CodeContext.InWith) == 0 && !variable._descriptor.captured)
            {
