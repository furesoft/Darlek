				...
				case JSValueType.Integer:
					{
						...
						switch (tjso._valueType)
						{
							...
							case JSValueType.Integer:
								{
									return tint == tjso._iValue ? BaseLibrary.Boolean.True : BaseLibrary.Boolean.False;
								}
							case JSValueType.Double:
								{
									return tint == tjso._dValue ? BaseLibrary.Boolean.True : BaseLibrary.Boolean.False;
								}
							case JSValueType.String:
								{
									tstr = tjso._oValue.ToString();
									if (Tools.ParseNumber(tstr, ref index, out tdouble) && (index == tstr.Length))
										return tint == tdouble ? BaseLibrary.Boolean.True : BaseLibrary.Boolean.False;
									else
										return false;
								}
				...
				case JSValueType.Double:
					{
						...
						switch (tjso._valueType)
						{
							...
							case JSValueType.Integer:
								{
									return tdouble == tjso._iValue ? BaseLibrary.Boolean.True : BaseLibrary.Boolean.False;
								}
							case JSValueType.Double:
								{
									return tdouble == tjso._dValue ? BaseLibrary.Boolean.True : BaseLibrary.Boolean.False;
								}
							case JSValueType.String:
								{
									tstr = tjso._oValue.ToString();
				...
				case JSValueType.String:
					{
						...
						switch (temp._valueType)
						{
							...
							case JSValueType.Integer:
								{
									if (Tools.ParseNumber(tstr, ref index, out tdouble) && (index == tstr.Length))
										return tdouble == temp._iValue ? BaseLibrary.Boolean.True : BaseLibrary.Boolean.False;
									else
										return false;
								}
							case JSValueType.Double:
								{
									if (Tools.ParseNumber(tstr, ref index, out tdouble) && (index == tstr.Length))
										return tdouble == temp._dValue ? BaseLibrary.Boolean.True : BaseLibrary.Boolean.False;
									else
										return false;
								}
							case JSValueType.String:
								{
									return string.CompareOrdinal(tstr, temp._oValue.ToString()) == 0 ? BaseLibrary.Boolean.True : BaseLibrary.Boolean.False;
								}
				...
				case JSValueType.Object:
					{
						...
						switch (tjso._valueType)
						{
							...
							case JSValueType.Integer:
								{
									...
									switch (temp._valueType)
									{
										...
										case JSValueType.Integer:
											{
												return temp._iValue == tdouble ? BaseLibrary.Boolean.True : BaseLibrary.Boolean.False;
											}
										case JSValueType.Double:
											{
												return temp._dValue == tdouble ? BaseLibrary.Boolean.True : BaseLibrary.Boolean.False;
											}
										case JSValueType.String:
											{
												tstr = temp._oValue.ToString();
							...
							case JSValueType.String:
								{
									...
									switch (temp._valueType)
									{
										...
										case JSValueType.String:
											{
												return temp._oValue.ToString() == tstr ? BaseLibrary.Boolean.True : BaseLibrary.Boolean.False;
											}
									}
									break;
								}
							default:
								{
									return temp._oValue == tjso._oValue ? BaseLibrary.Boolean.True : BaseLibrary.Boolean.False;
								}
						}
						break;
					}
				...
				case JSValueType.NotExists:
					{
						...
						switch (temp._valueType)
						{
							case JSValueType.Object:
								{
									return temp._oValue == null ? BaseLibrary.Boolean.True : BaseLibrary.Boolean.False;
								}
							default:
								{
									return !temp.Defined ? BaseLibrary.Boolean.True : BaseLibrary.Boolean.False;
								}
						}
					}
				default:
