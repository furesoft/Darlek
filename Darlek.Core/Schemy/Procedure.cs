...
public class Procedure(Union<Symbol, List<Symbol>> parameters, object body, Environment env) : ICallable
{
    ...
    public object Call(List<object> args)
    {
        ...
        return Interpreter.EvaluateExpression(body, Environment.FromVariablesAndValues(parameters, args, env));
    }
    ...
    {
        var form = new List<object> { Symbol.LAMBDA, parameters.Use(sym => (object)sym, syms => syms.Cast<object>().ToList()), body };
